    ...
    return (
        <Grid container spacing={2}>
            <Grid size={5} container>
                ...
                <Grid size={8} container direction={'column'} justifyContent={'center'} spacing={1}>
                ...
                <Grid size={6}>
                    <List>
                        ...
                        <ListItem>
                            ...
                            <ListItemText primary="Опыт работы" secondary="10 лет"/>
                        </ListItem>
                ...
                <Grid size={6}>
                    <List>
                        <ListItem>
                            ...
                            <ListItemText primary="Проживание"
                                          secondary="Московская область, г.о. Красногорск, п. Ильинское-Усово"/>
                        </ListItem>
                        <ListItem>
                            <ListItemAvatar>
                                <Avatar>
                            ...
                            <ListItemText primary="Формат работы" secondary="Полная занятость, Гибрид, Удаленно."/>
                        </ListItem>
                        <ListItem>
                            <ListItemAvatar>
                                <Avatar>
                            ...
                            <ListItemText primary="Гражданство" secondary="Российская федерация"/>
                        </ListItem>
                    </List>
                </Grid>
            </Grid>
